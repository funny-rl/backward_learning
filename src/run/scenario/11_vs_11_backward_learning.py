...
def build_scenario(builder):
  ...
  if not level["eval"]:
    ...
    builder.AddPlayer(left_team_pos[1][0], left_team_pos[1][1], e_PlayerRole_RM)
    builder.AddPlayer(left_team_pos[2][0], left_team_pos[2][1], e_PlayerRole_CF)
    builder.AddPlayer(left_team_pos[3][0], left_team_pos[3][1], e_PlayerRole_LB)
    builder.AddPlayer(left_team_pos[4][0], left_team_pos[4][1], e_PlayerRole_CB)
    builder.AddPlayer(left_team_pos[5][0], left_team_pos[5][1], e_PlayerRole_CB)
    builder.AddPlayer(left_team_pos[6][0], left_team_pos[6][1], e_PlayerRole_RB)
    builder.AddPlayer(left_team_pos[7][0], left_team_pos[7][1], e_PlayerRole_CM)
    builder.AddPlayer(left_team_pos[8][0], left_team_pos[8][1], e_PlayerRole_CM)
    builder.AddPlayer(left_team_pos[9][0], left_team_pos[9][1], e_PlayerRole_CM)
    builder.AddPlayer(left_team_pos[10][0], left_team_pos[10][1], e_PlayerRole_LM)
