...
class _11_vs_11_Easy_Stochastic(MultiAgentEnv):
    def __init__(
        self,
        dense_reward=False,
    ...
    def step(self, actions):
        ...
        own_changing_r, oob_r, pass_r, yellow_r, ball_position_r, score_r = self.reward_model.calc_reward(self.pre_obs[0], o[0], done)
